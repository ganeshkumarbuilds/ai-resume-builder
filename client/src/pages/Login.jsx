import { Lock, Mail, MailIcon, User2Icon } from 'lucide-react'
  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-gray-50'>
        <form onSubmit={handleSubmit} className="sm:w-[450px] w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-white">
                ...
                <p className="text-gray-500 text-sm mt-2">Please sign {state} to continue</p>
                {state !== "login" && (
                    <div className="flex items-center mt-6 w-full bg-white border border-gray-300/80 h-12 rounded-full overflow-hidden pl-6 gap-2">
                        <User2Icon size={18} color='#111111'/>
