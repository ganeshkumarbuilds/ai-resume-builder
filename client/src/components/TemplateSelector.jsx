...
const TemplateSelector = ({ selectedTemplate, onChange}) => {
    ...
    const templates = [
        {
            id: "classic",
            name: "Classic",
            preview: "A clean, traditional resume format with clear sections and professional typograph"
        },
        {
            id: "modern",
            name: "Modern",
  ...
  return (
    <div className='relative'>
        ...
        bg-gradient-to-brfrom-blue-50 to-blue-100 ring-blue-300 hover:ring transition-all px-3 py-2 rounded-lg '>
        ...
        {isOpen &&(
            ...
            rounded-md border border-gray-200 shadow-sm'>
                {templates.map((template)=>(
                    ...
                    setIsOpen(false)}} className={`relative p-3 border rounded-md cursor-pointer transition-all ${selectedTemplate === template.id ?
