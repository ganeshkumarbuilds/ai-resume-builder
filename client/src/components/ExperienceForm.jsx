import { BriefcaseIcon, Loader2, Plus, Sparkles, Trash2 } from 'lucide-react'
  ...
  return (
    <div className='space-y-6'>
        <div>
            ...
            <button onClick={addExperience} className='flex items-center gap-2 px-3 py-1 text-sm bg-green-100 text-green-700 rounded hover:bg-green-200 rounded-lg hover:bg-green-200
            transition-colors '>
                    ...
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className='space-y-2'>
                            <div className='flex items-center justify-between'>
                                ...
                                className='flex items-center gap-2 px-3 py-1.5 text-sm bg-gradient-to-r from-purple-500 to-violet-600 text-white rounded-lg hover:from-purple-600 hover:to-violet-700 transition-all shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed font-medium'>
