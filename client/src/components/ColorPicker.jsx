...
const ColorPicker = ({selectedColor, onChange }) => {
  ...
  return (
    <div className='relative'>
        <button onClick={()=>setIsOpen(!isOpen)} className='flex items-center gap-1 text-sm text-purple-600 bg-gradient-to-brfrom-purple-50 to-purple-600
        ring-purple-300 hover:ring transition-all px-3 py-2 rounded-lg'>
            <FaPallet size={16}/> <span className='max-sm:hidden'>Accent</span>
