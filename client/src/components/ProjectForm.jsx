  ...
  return (
   <div>
        <div>
            ...
            <button onClick={addProject} className='flex items-center gap-2 px-3 py-1 text-sm bg-green-100 text-green-700 rounded hover:bg-green-200 rounded-lg hover:bg-green-200
            transition-colors '>
                ...
                {data.map((project, index)=>(
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className='grid  gap-3 '>
                            ...
                            <textarea rows={4} value={project.description || ""} onChange={(e)=>updateProject(index, "description", e.target.value)} type="text" placeholder='Describe your project...' className='w-full px-3 py-2 text-sm rounded-lg resize-none'/>
                        </div>
                    </div>
                ))}
